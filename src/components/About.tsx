            ...
            <Grid container>
                ...
                <Fragment>
                    <Grid item xs={4} sx={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        <Typography variant={'h6'}>Born and raised in Montana outside of Glacier National Park I spent
                            my
                            youth exploring
                ...
                <Fragment>
                    ...
                    <Grid item xs={4} sx={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        <Typography variant={'h6'}>I attended <Link href={'https://www.conncoll.edu/'}>Connecticut
                            ...
                            the <Link href={'https://camelathletics.com/sports/mens-rowing'}>Varsity Rowing</Link> team
                            for
